<script setup>
	useHead({
		title: 'Contact Us - Pandey Education Trust',
	});
</script>
		...
		<div class="section-container">
			...
			<div class="text-center mb-12 animate-fade-in-up">
				...
				<p class="section-subtitle max-w-3xl mx-auto">
					Get in touch with us for quality education consultancy services
				</p>
			</div>
			...
			<div class="max-w-4xl mx-auto">
				...
				<div class="text-center mb-8">
					<h2 class="text-2xl md:text-3xl font-heading font-bold text-neutral-900 mb-2">
						Pandey Education Trust
					</h2>
					<p class="text-lg text-accent-600 font-semibold">
						(A TRUSTED NAME IN QUALITY EDUCATION CONSULTANCY SERVICES)
					</p>
				</div>

				<div class="space-y-6">
					<!-- Contact Person -->
				<div class="flex items-start gap-4 p-4 bg-gradient-to-br from-primary-50 to-accent-50 rounded-xl border-l-4 border-primary-600">
					<div class="flex-shrink-0">
						<img 
							src="/pavan.jpg" 
							alt="Pavan Kumar" 
							class="h-16 w-16 rounded-lg object-cover object-top border-2 border-primary-300"
						/>
					</div>
						<div>
					...
					<!-- Phone Numbers -->
					<div class="flex items-start gap-4 p-4 bg-white rounded-xl border border-neutral-200">
						...
						<div>
							...
							<p class="text-neutral-700 text-sm">
								<a href="tel:9640036681" class="link-primary block">9640036681</a>
								<a href="tel:8696288426" class="link-primary block">8696288426</a>
								<a href="tel:9799298158" class="link-primary block">9799298158</a>
							</p>
						</div>
					</div>
