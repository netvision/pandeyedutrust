...
<template>
	...
	<div class="content">
		...
		<p>PET has also qualified for 80G Exemption with the CIT, Jaipur vide their order no. AC-II/ (Ta & Naya)/80G/07-08/965 dated 31.07.2007 and through their letter no. AC/JPR-II/AC(Ta &amp; Naya) 133/2009-10/1594 dated 03.02.10 they have informed that no further application is required for extension of exemption.</p>
	</div>
	<Footer />
</template>
<style scoped>
